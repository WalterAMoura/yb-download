...
class Database
{
     ...
     * @return PDOStatement
     */
    public function select($where = null, $order = null, $limit = null, $group = null, $fields = '*'){
        //DADOS DA QUERY
        ...
        //MONTA A QUERY
        $query = 'SELECT '.$fields.' FROM '.$this->table.' '.$where.' '.$order.' '.$limit.' '.$group;
     ...
     * @return int
     */
    public function proc($procedure){
        //MONTA A QUERY
        $proc = $procedure;

        //EXECUTA A QUERY
        return $this->execute($proc)->rowCount();
